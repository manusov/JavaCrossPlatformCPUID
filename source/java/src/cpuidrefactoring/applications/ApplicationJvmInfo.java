...
------------------------------------
Sub-application class for show Java Virtual Machine (JVM) information.
...
public class ApplicationJvmInfo extends ApplicationController
{
public ApplicationJvmInfo()
    {
...
private class BuildModel extends ApplicationModel
    ...
    private BuildModel()
        ...
        device = r.loadDriver( Registry.CPR.DRIVER_JVMINFO );
