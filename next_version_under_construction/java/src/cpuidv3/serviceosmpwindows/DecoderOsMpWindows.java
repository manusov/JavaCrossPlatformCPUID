...
import cpuidv3.serviceosmp.HelperMemorySize;
import static cpuidv3.serviceosmp.HelperMemorySize.writeMemorySize;
import cpuidv3.serviceosmpwindows.EntryCache.PROCESSOR_CACHE_TYPE_WINDOWS;
import static cpuidv3.serviceosmpwindows.HelperBinaryParsing.getVariableSize;
import static cpuidv3.serviceosmpwindows.HelperGlpi.interpreterGlpi;
import static cpuidv3.serviceosmpwindows.HelperGlpiEx.interpreterGlpiEx;
import static cpuidv3.serviceosmpwindows.HelperStrings.affinityCount;
import static cpuidv3.serviceosmpwindows.HelperStrings.bitmapString;
import cpuidv3.services.SAL.OSTYPE;
import java.util.ArrayList;

public class DecoderOsMpWindows extends DecoderOsMp
{
    ...
    @Override public boolean initBinary( OSTYPE osType, int osOpt )
    {
        initStatus = false;
    ...
    // Part 2.2 = Build string arrays from topology entries list.
        ...
        for( TopologyRelationship entry : entries )
        {
            ...
            if ( entry instanceof EntryProcessorCore )
            {
                ...
                entryList.add( new String[] { "Efficiency class", "" + e.efficiencyClass } );
                nThread += affinityCount( e.groups );
            }
