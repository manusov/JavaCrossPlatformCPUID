...
import static cpuidv3.serviceosmp.HelperBitmap.longsCount;
import cpuidv3.serviceosmp.HelperMemorySize.UNITS;
import static cpuidv3.serviceosmp.HelperMemorySize.writeMemorySize;
import cpuidv3.serviceosmplinux.EntryCache.CACHE_TYPE_LINUX;
import static cpuidv3.serviceosmplinux.HelperSummaryBuilding.removeDuplicates;
import static cpuidv3.serviceosmplinux.HelperSummaryBuilding.removeDuplicatesCaches;
import static cpuidv3.serviceosmplinux.HelperSysfsParsing.SYS_CPU_PATH;
import static cpuidv3.serviceosmplinux.HelperSysfsParsing.buildEntry;
import static cpuidv3.serviceosmplinux.HelperSysfsParsing.decodeList;
import static cpuidv3.serviceosmplinux.HelperSysfsParsing.readParameter;
import cpuidv3.services.SAL;
import java.util.ArrayList;

public class DecoderOsMpLinux extends DecoderOsMp
{
    private boolean initStatus = false;
    private int[] cpuIndexesList;
    
    @Override public boolean initBinary( SAL.OSTYPE osType, int osOpt )
    {
    ...
    @Override public boolean parseBinary()
    {
        ...
        for( Affinity a : cores )
        {
            ...
            nThread += longsCount( core.affinity_mask );
