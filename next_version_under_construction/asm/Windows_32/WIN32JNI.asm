...
initBinary     , 'Java_cpuidv3_services_PAL_initBinary'    , \
deinitBinary   , 'Java_cpuidv3_services_PAL_deinitBinary'  , \
requestBinary  , 'Java_cpuidv3_services_PAL_requestBinary'
