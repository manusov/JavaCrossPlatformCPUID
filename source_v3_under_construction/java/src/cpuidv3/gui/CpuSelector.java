...
public final class CpuSelector 
{
    ...
    public int getCpuSelected()       { return cpuSelected;   }
    public boolean getAffEnabled()    { return affEnabled;    }
    public boolean getMakeSelection() { return makeSelection; }
    
    public CpuSelector( int count )
    {
        cpuCount = count;
        cpuSelected = 0;
        affEnabled = false;
