...
import static dumploader.cpudata.VendorDetectVirtual.HYPERVISOR_T.HYPERVISOR_XEN;
...
*/
    ...
    {
//      String s1 = ( accumVendorName != null ) ? accumVendorName : "?";
//      String s2 = ( accumCpuName    != null ) ? accumCpuName    : "?";
...
//              ( accumVendorName != null ) ? accumVendorName : "?" },
            { "Processor model"  , accumCpuName }
//              ( accumCpuName    != null ) ? accumCpuName    : "?" }
        };
    }
