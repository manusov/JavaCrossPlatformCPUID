...
public checkPAL  as  'Java_arch1_kernel_PAL_checkPAL'
public entryPAL  as  'Java_arch1_kernel_PAL_entryPAL'
...
FunctionSelector   DQ  Reserved_Function
                   ...
                   DQ  Reserved_Function
                   DQ  Get_CPUID         ; Get CPUID dump
                   DQ  Get_CPUCLK        ; Measure CPU TSC frequency
