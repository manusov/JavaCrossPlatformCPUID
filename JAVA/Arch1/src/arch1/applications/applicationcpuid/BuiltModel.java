...
import arch1.applications.guimodels.ListEntry;
import arch1.applications.guimodels.ListEntryTables;
...
protected class CpuidModelBuilder implements ModelBuilder 
    ...
    private final static int GETCPUID = 3;
    ...
    public CpuidModelBuilder()
        ...
        jniStatus = r.binaryChannel( null, opb, GETCPUID, OPBQWORDS );
        //--- Initialize CPR ---
        statusInit = false;
        statusParse = false;
        //--- Load driver ---
