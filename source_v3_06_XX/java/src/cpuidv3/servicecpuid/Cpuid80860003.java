...
{
Cpuid80860003() { setFunction( 0x80860003 ); }
...
@Override String[][] getParametersList()
    ...
    EntryCpuidSubfunction[] e1 = buildEntries( 0x80860003 );
    EntryCpuidSubfunction[] e2 = buildEntries( 0x80860004 );
    EntryCpuidSubfunction[] e3 = buildEntries( 0x80860005 );
    EntryCpuidSubfunction[] e4 = buildEntries( 0x80860006 );
