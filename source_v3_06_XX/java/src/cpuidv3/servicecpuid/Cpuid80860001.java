...
Class for support CPUID Vendor Specific Function 80860001h =
Transmeta vendor-specific: Transmeta get processor information.
...
class Cpuid80860001 extends ParameterFunctionCpuid
{
Cpuid80860001() { setFunction( 0x80860001 ); }
...
@Override String[][] getParametersList()
    ...
    if ( ( entries != null )&&( entries.length > 0 ) )
        ...
        EntryCpuidSubfunction[] cacheEntries = buildEntries( 0x80000006 );
        ...
        if ( entries[0].ebx != 0x02000000 )
            ...
            EntryCpuidSubfunction[] altentries = buildEntries( 0x80860002 );
