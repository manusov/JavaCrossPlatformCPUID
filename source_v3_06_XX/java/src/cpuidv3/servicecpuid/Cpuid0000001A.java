...
{
Cpuid0000001A() { setFunction( 0x0000001A ); }
...
@Override String[][] getParametersList()
    ...
    @Override public HybridReturn getHybrid()
    {
        ...
        EntryCpuidSubfunction[] fn4 = buildEntries( 0x00000004 );
        if( fn4 != null )
        {
        ...
        EntryCpuidSubfunction[] fn1F = buildEntries( 0x0000001F );
        if( fn1F != null )
        {
        ...
        EntryCpuidSubfunction[] fn7 = buildEntries( 0x00000007 );
