...
Class for support CPUID Virtual Function 40000010h =
Virtual CPUID: timing information (Generic Virtual CPUID).
...
class Cpuid40000010 extends ParameterFunctionCpuid
{
Cpuid40000010() { setFunction( 0x40000010 ); }
