...
final class About
{
    ...
    // Depends on icon Xsize = 32.
    private final static int X1 = ( BOX_X - 32 ) / 2;
    // Depends on string Xsize.
    private final static int X2 = ( BOX_X - 155 ) / 2;
    private final static int X3 = ( BOX_X - 105 ) / 2;
    private final static int X4 = ( BOX_X - 230 ) / 2;
    private final static int X5 = ( BOX_X - BUTTONS12_X ) / 2;
    private final static int X6 = ( BOX_X - BUTTONS12_X ) / 2;
    private final static int X7 = ( BOX_X - BUTTON3_X ) / 2;
    ...
    JDialog createDialog( JFrame parentWin )
    {
        ...
        { 
            l1.setIcon(new javax.swing.ImageIcon(getClass().
                getResource( CPUIDv3.getAppLogo())));
        } 
        catch ( Exception e ) { }
        
        // Create labels with application information strings.
        JLabel l2 = new JLabel( CPUIDv3.getLongName() + "." );
        JLabel l3 = new JLabel( CPUIDv3.getVendorName1() );
        JLabel l4 = new JLabel( CPUIDv3.getVendorName2() );
        ...
        b1.addActionListener( ( ActionEvent e ) -> 
        {
            ...
            {   // web access
                ...
                { 
                    Desktop.getDesktop().
                        browse(new URI( CPUIDv3.getProjectWeb() )); 
                }
        ...
        b2.addActionListener( ( ActionEvent ae1 ) -> 
        {
            ...
            { // web access
                ...
                { 
                    Desktop.getDesktop().
                        browse(new URI( CPUIDv3.getAllWeb() )); 
                }
                catch ( IOException | URISyntaxException ex ) { } 
            }
        });
