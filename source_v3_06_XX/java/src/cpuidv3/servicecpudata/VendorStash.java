...
Processors and Hypervisors data base class:
...
final class VendorStash 
{

VENDOR_T      vendor     = null;
HYPERVISOR_T  hypervisor = null;

// This part of class contains fields, loaded from dump
// and fields, set as dump analyzing results.
// this part must be actual before VendorInitPhysical buildStash() method call.

boolean  saw_4  = false;    // Means CPUID function 00000004h supported.
boolean  saw_b  = false;    // Means CPUID function 0000000Bh supported.
boolean  saw_1f = false;    // Means CPUID function 0000001Fh supported.

boolean hybridCheck = false;   // Intel Hybrid technology support.
boolean bigCore     = false;
boolean smallCore   = false;
boolean zeroCore    = false;
...
int    val_2_edx = 0;
int    val_4_eax = 0;
int[]  val_b_eax  = new int[2];
int[]  val_b_ebx  = new int[2]; 
int[]  val_1f_eax = new int[6];
int[]  val_1f_ebx = new int[6];
int[]  val_1f_ecx = new int[6];

int    val_80000001_eax = 0;
int    val_80000001_ebx = 0;
int    val_80000001_ecx = 0;
int    val_80000001_edx = 0;
int    val_80000008_ecx = 0;
int    val_8000001e_ebx = 0;
int    val_80000006_ecx = 0;

String brand          = null;
String transmeta_info = null;
String override_brand = null;
String soc_brand      = null;

// internal part, but with getters for some parameters,
// requires externally read, but not requires externally write
String getMpMethod()    { return mp.method;       }
int getMpCores()        { return mp.cores;        }
int getMpHyperthreads() { return mp.hyperthreads; }
int getMpUnits()        { return mp.units;        }
