...
class HelperTable 
{
    static void optimizeSingleTable
    ...
    static void optimizeColumnsWidths( JTable table, int xSize )
    {
        ...
        // Cycle for find max. column string length in the table content part.
        for ( int i=0; i<m; i++ )
        {
            for ( int j=0; j<n; j++ )
            {
