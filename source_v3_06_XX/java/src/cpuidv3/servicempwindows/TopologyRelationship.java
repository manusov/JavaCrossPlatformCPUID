...
{
/*
    static enum LOGICAL_PROCESSOR_RELATIONSHIP
    {
    ...
    final LOGICAL_PROCESSOR_RELATIONSHIP relationship;
    final int size;
    TopologyRelationship(LOGICAL_PROCESSOR_RELATIONSHIP r, int s)
    {
        relationship = r;
        size = s;
    }
