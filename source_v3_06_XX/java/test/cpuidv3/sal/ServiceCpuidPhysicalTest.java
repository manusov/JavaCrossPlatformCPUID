/*
Test for class ServiceCpuidPhysical.java.
...
public class ServiceCpuidPhysicalTest 
{
    public ServiceCpuidPhysicalTest() {  }
    ...
    @Test public void testGetTable()
    {
        ...
        Service service = sal.getService( SERVICE_ID.CPUID_PHYSICAL );
        if ( service == null )
        {
            fail( "Service object is null." );
            return; // This return for fix next warning about null pointer.
        }
        ...
        ChangeableTableModel tableModel = sal.getDumpTable();
        if ( tableModel == null )
        {
