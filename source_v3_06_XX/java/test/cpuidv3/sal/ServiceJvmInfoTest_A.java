/*
Unit test for class: ServiceJvmInfo.java.
Get Java Virtual Machine and environment information
...
public class ServiceJvmInfoTest_A 
{
...
*/    
    ...
    public ServiceJvmInfoTest_A() 
    {
        System.out.println( "ServiceJvmInfoTest() runs." );
    }
    ...
    {
        System.out.println( "Test class ServiceJvmInfo.java." );
        SAL sal = new SAL();
        ServiceJvmInfo service = new ServiceJvmInfo( sal );
