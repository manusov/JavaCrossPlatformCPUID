/*
Test for class ServiceOsInfo.java.
...
public class ServiceOsInfoTest 
{
    public ServiceOsInfoTest() { }
    ...
    @Test public void testGetTable()
    {
        ...
        Service service = sal.getService( SERVICE_ID.OS_INFO );
        if ( service == null )
        {
        ...
        ChangeableTableModel tableModel = sal.getOsTable();
        if ( tableModel == null )
        {
