...
public class HelperCpuidReaderTest
{
    ...
    {
        System.out.println( "HelperCpuidReaderTest() runs." );
    }
    ...
    {
        System.out.println( "Test class HelperCpuidReader.java.\r\n" );
        
        System.out.println( "pal.getCpuid()." );
        helperPrintTable( pal.getCpuid() );
        
        String formatString = "pal.getCpuidSubfunction( %08Xh, %08Xh ).";
