...
public class PanelOsTest 
{
    private final String TEST_NAME = "Test class PanelOs.java";
    private final int X_SIZE = 700;
    private final int Y_SIZE = 700;
    private final int WAIT_QUANT_MS = 100;
    private PanelOs testedPanel = null;
    ...
    @Before public void setUp() throws Exception 
    {
        ...
        testedPanel = new PanelOs( localSAL );
    }
...
public class PanelOsTest 
{
    public PanelOsTest()
    {
        System.out.println( "PanelOsTest() runs." );
    }
