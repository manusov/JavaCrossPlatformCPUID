/*
Test for class PanelClock.java.
...
public class PanelClockTest 
{
    private final String TEST_NAME = "Test class PanelClock.java";
    private final int X_SIZE = 520;
    private final int Y_SIZE = 520;
    private final int WAIT_QUANT_MS = 100;
    private PanelClock testedPanel = null;
    private boolean termination = false;

    public PanelClockTest() { }
...
import org.junit.Test;
import static org.junit.Assert.*;  // Reserved for fail( msg ).
...
public class PanelClockTest
{
    ...
    public PanelClockTest()
    {
        System.out.println( "PanelClockTest() runs." );
    }
    ...
    public void testTarget()
    {
        ...
        System.out.println( "--- getPanelName() ---" );
        String resultString = testedPanel.getPanelName();
        System.out.println( resultString );
        
        System.out.println( "--- getPanelIcon() ---" );
        resultString = testedPanel.getPanelIcon();
        System.out.println( resultString );
        
        System.out.println( "--- getPanel() ---" );
        JPanel resultPanel = testedPanel.getPanel();
        System.out.println( "" + resultPanel );
        
        System.out.println( "--- getPanelActive() ---" );
        boolean resultBool = testedPanel.getPanelActive();
        System.out.println( "" + resultBool );
        
        System.out.println( "--- getPanelTip() ---" );
        resultString = testedPanel.getPanelTip();
        System.out.println( resultString );
