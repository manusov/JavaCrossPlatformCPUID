/*
Test for class PanelContext.java.
...
public class PanelContextTest 
{
    private final String TEST_NAME = "Test class PanelContext.java";
    private final int X_SIZE = 520;
    private final int Y_SIZE = 520;
    private final int WAIT_QUANT_MS = 100;
    private PanelContext testedPanel = null;
    private boolean termination = false;

    public PanelContextTest() { }

    @Before public void setUp() throws Exception 
    {
        SAL localSAL = SALHW.getInstance( getResourcePackage() );
        testedPanel = new PanelContext( localSAL );
    }
...
public class PanelContextTest
{
    public PanelContextTest()
    {
        System.out.println( "PanelContextTest() runs." );
    }
