...
public class PanelJvmTest 
{
    private final String TEST_NAME = "Test class PanelJvm.java";
    private final int X_SIZE = 510;
    private final int Y_SIZE = 510;
    private final int WAIT_QUANT_MS = 100;
    private PanelJvm testedPanel = null;
...
public class PanelJvmTest 
{
    public PanelJvmTest()
    {
        System.out.println( "PanelJvmTest() runs." );
    }
