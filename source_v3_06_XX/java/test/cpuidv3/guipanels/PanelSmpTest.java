...
public class PanelSmpTest 
{
    private final String TEST_NAME = "Test class PanelSmp.java";
    private final int X_SIZE = 800;
    private final int Y_SIZE = 900;
    private final int WAIT_QUANT_MS = 100;
    private PanelSmp testedPanel = null;
    ...
    @Before public void setUp() throws Exception 
    {
        ...
        testedPanel = new PanelSmp( localSAL );
    }
...
public class PanelSmpTest 
{
    public PanelSmpTest()
    {
        System.out.println( "PanelSmpTest() runs." );
    }
