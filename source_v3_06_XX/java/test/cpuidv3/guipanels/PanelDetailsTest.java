/*
Test for class PanelDetails.java.
...
public class PanelDetailsTest 
{
    private final String TEST_NAME = "Test class PanelDetails.java";
    private final int X_SIZE = 800;
    private final int Y_SIZE = 900;
    private final int WAIT_QUANT_MS = 100;
    private PanelDetails testedPanel = null;
    private boolean termination = false;

    public PanelDetailsTest() { }

    @Before public void setUp() throws Exception 
    {
        SAL localSAL = SALHW.getInstance( getResourcePackage() );
        localSAL.getSummaryTable();  // For system information requests order.
        testedPanel = new PanelDetails( localSAL );
    }
...
public class PanelDetailsTest 
{
    public PanelDetailsTest()
    {
        System.out.println( "PanelDetailsTest() runs." );
    }
